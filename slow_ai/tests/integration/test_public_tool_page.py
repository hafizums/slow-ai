...
class TestPublicToolPage(FrappeTestCase):
    ...
    def test_public_tool_page_uses_only_safe_backend_apis(self):
        ...
        self.assertNotIn("slow_ai.api.public_tools.cleanup_stale_tool_drafts", page.script)
        ...
        self.assertIn("slow_ai.api.projects.list_members", page.script)
        self.assertIn("slow_ai.api.projects.add_member", page.script)
        self.assertIn("slow_ai.api.projects.update_member_role", page.script)
        self.assertIn("slow_ai.api.projects.disable_member", page.script)
        self.assertIn("data-role=\"project-member-form\"", page.script)
        self.assertIn("this.$memberForm.hide()", page.script)
        self.assertIn("this.$memberForm.show()", page.script)
        self.assertIn("Project member management unavailable", page.script)
        self.assertIn("Project member action failed", page.script)
        self.assertIn("safeProjectMembershipCall", page.script)
        self.assertIn("$.ajax({", page.script)
        self.assertIn("url: `/api/method/${method}`", page.script)
        self.assertIn("reject(new Error(\"Project member action failed\"))", page.script)
